        ...
        <div class="navbar-nav ms-auto">
          ...
          <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu rounded-0 rounded-bottom m-0">
              ...
              <a href="pacotes.php" class="dropdown-item">Planos</a>
              <a href="visiting.php" class="dropdown-item">Horas de visita</a>
      ...
      <div class="container py-5">
        <div class="row g-5">
          <div class="col-md-6 wow fadeIn" data-wow-delay="0.3s">
            <h1 class="display-6 text-white mb-5">Horário de funcionamento</h1>
          ...
          <div class="col-md-6 text-light wow fadeIn" data-wow-delay="0.5s">
            <h1 class="display-6 text-white mb-5">Contato</h1>
            <table class="table">
              <tbody>
                <tr>
                  <td>Escritório</td>
                  <td>Av. Dinossauros, Palo Alto - CA, EUA</td>
                </tr>
                <tr>
                  <td>Parque</td>
                  <td>Isla Nublar, Costa Rica</td>
                </tr>
                <tr>
                  <td>Ingressos</td>
                  <td>
                    <p class="mb-2">+001 120 1990</p>
                    <p class="mb-0">jurassicpark.com</p>
                  </td>
                </tr>
                <tr>
                  <td>Suporte</td>
                  <td>
                    <p class="mb-2">+000 613 1993</p>
                    <p class="mb-0">jurassicpark_support@gmail.com</p>
                  </td>
                </tr>
              </tbody>
            </table>
